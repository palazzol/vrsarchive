 ...
 */
/*
 * configuration file for xenix 286 systems
 */

/*
 * memory sizes.
 */
#define MAXMEM  (memp)0177777   /* max amount of memory */
#define MEMINC  1023            /* sizeof memory increments -1 */
...
/* #define BSD42     /* if using a 4.2 system */
