...
#define BITMAPSIZE	2048	/* Must be a power of 2 */
...
extern	char	*infile, *outfile, PAGER[];
extern	char	bitmap[], *temprc, *MAILER, *MAILPARSER;
...
extern int	mode, ngrp, line, newrc(), readmode;
