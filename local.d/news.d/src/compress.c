...
#ifdef pdp11
#define	BITS	12			/* maximum number of bits/code */
#define NO_UCHAR
#else !pdp11
#ifndef BITS
 ...
 * N*(N-1)/2 characters.  With 8000 chars in the stack, an input
 * file would have to contain a 40Mb string of a single character.
 * This seems unlikely.
 */
...
Usage() {
#ifdef DEBUG
fprintf(stderr,"Usage: compress [-dDvqfc] [-b maxbits] [file ...]\n");
}
int debug = 0;
#else DEBUG
fprintf(stderr,"Usage: compress [-dfqc] [-b maxbits] [file ...]\n");
}
#endif DEBUG
...
register int argc; char **argv;
{
    ...
    *filelist = NULL;
	...
	for (fileptr = filelist; *fileptr; fileptr++) {
	    exit_stat = 0;
	    if (do_decompress != 0) {			/* DECOMPRESSION */
		/* Check for .Z suffix */
