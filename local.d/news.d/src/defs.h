...
#ifndef HOME
#define	ROOTID	12	/* uid of person allowed to cancel anything	*/
#endif
...
#define MYORG "Intel Corporation, Hillsboro, OR"	/* My organization.  Please	*/
...
#define SYSPATH	"PATH=/bin:/usr/bin"	/* default, secure, vanilla path */
