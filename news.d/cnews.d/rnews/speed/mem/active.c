 ...
 *	TODO: use hashing for speed & to eliminate MAXNGS
 */
...
/* TODO: make this a linked list to avoid the MAXNGS limit? */
static char *artlnps[MAXNGS];	/* point at lines in active file */

/* TODO: make these two macros in a header file? */
long
nxtartnum(ng)
char *ng;
{
